...
class Ui_plotter(object):
    def setupUi(self, plotter):
        ...
        self.tabWidget.setGeometry(QRect(10, 10, 851, 531))
        ...
        self.plot_combo.setGeometry(QRect(30, 30, 181, 22))
        self.plot_combo.setEditable(False)
        self.xmin_lbl = QLabel(self.plot_tab)
        self.xmin_lbl.setObjectName(u"xmin_lbl")
        self.xmin_lbl.setGeometry(QRect(30, 440, 31, 20))
        self.save_btn = QPushButton(self.plot_tab)
        self.save_btn.setObjectName(u"save_btn")
        self.save_btn.setGeometry(QRect(730, 440, 101, 41))
        self.update_btn = QPushButton(self.plot_tab)
        self.update_btn.setObjectName(u"update_btn")
        self.update_btn.setGeometry(QRect(720, 30, 101, 24))
        self.tabWidget.addTab(self.plot_tab, "")

        self.retranslateUi(plotter)

        self.tabWidget.setCurrentIndex(0)
        self.plot_combo.setCurrentIndex(-1)
    ...
    def retranslateUi(self, plotter):
        ...
        self.plot_combo.setItemText(1, QCoreApplication.translate("plotter", u"Heatmap", None))

        self.xmin_lbl.setText(QCoreApplication.translate("plotter", u"xmin:", None))
        self.save_btn.setText(QCoreApplication.translate("plotter", u"Save Plot", None))
        self.update_btn.setText(QCoreApplication.translate("plotter", u"Update Plot", None))
